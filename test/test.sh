...
#-H "Authorization: Token 74bd3673e5b76918c4fb6f0d9e8bbd9c25ff9b24" -H "Content-Type: application/json" http://atnog-homeassistant.av.it.pt:8000/stay/add
...
#curl -s -X GET "http://atnog-homeassistant.av.it.pt:8000/stay/delete?token='123ABC'&userid=my@email.com&receipt_id=c8c37806-ef54-4d1b-a741-39f6e1868019"
...
#curl -s -X GET "hhttp://atnog-homeassistant.av.it.pt:8000/stay/clean?token='123ABC'&userid=my@email.com&receipt_id=c8c37806-ef54-4d1b-a741-39f6e1868019"
